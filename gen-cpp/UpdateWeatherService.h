...
class UpdateWeatherServiceIfSingletonFactory : virtual public UpdateWeatherServiceIfFactory {
 public:
  ...
  virtual UpdateWeatherServiceIf* getHandler(const ::apache::thrift::TConnectionInfo&) override {
    return iface_.get();
  }
  virtual void releaseHandler(UpdateWeatherServiceIf* /* handler */) override {}
...
class UpdateWeatherServiceNull : virtual public UpdateWeatherServiceIf {
 public:
  ...
  void UpdateWeather(const int64_t /* city */, const WeatherType::type /* w */) override {
    return;
  }
};
...
class UpdateWeatherService_UpdateWeather_args {
 public:
  ...
  UpdateWeatherService_UpdateWeather_args(const UpdateWeatherService_UpdateWeather_args&) noexcept;
  UpdateWeatherService_UpdateWeather_args& operator=(const UpdateWeatherService_UpdateWeather_args&) noexcept;
  UpdateWeatherService_UpdateWeather_args() noexcept
                                          : city(0),
                                            w(static_cast<WeatherType::type>(0)) {
  }
...
class UpdateWeatherService_UpdateWeather_result {
 public:
  ...
  UpdateWeatherService_UpdateWeather_result(const UpdateWeatherService_UpdateWeather_result&) noexcept;
  UpdateWeatherService_UpdateWeather_result& operator=(const UpdateWeatherService_UpdateWeather_result&) noexcept;
  UpdateWeatherService_UpdateWeather_result() noexcept {
  }
...
class UpdateWeatherServiceProcessorFactory : public ::apache::thrift::TProcessorFactory {
 public:
  UpdateWeatherServiceProcessorFactory(const ::std::shared_ptr< UpdateWeatherServiceIfFactory >& handlerFactory) noexcept :
