...
class WeatherServiceIfSingletonFactory : virtual public WeatherServiceIfFactory {
 public:
  ...
  virtual WeatherServiceIf* getHandler(const ::apache::thrift::TConnectionInfo&) override {
    return iface_.get();
  }
  virtual void releaseHandler(WeatherServiceIf* /* handler */) override {}
...
class WeatherServiceNull : virtual public WeatherServiceIf {
 public:
  ...
  WeatherType::type GetWeather(const int64_t /* city */) override {
    WeatherType::type _return = static_cast<WeatherType::type>(0);
    return _return;
  }
};
...
class WeatherService_GetWeather_args {
 public:
  ...
  WeatherService_GetWeather_args(const WeatherService_GetWeather_args&) noexcept;
  WeatherService_GetWeather_args& operator=(const WeatherService_GetWeather_args&) noexcept;
  WeatherService_GetWeather_args() noexcept
                                 : city(0) {
  }
...
class WeatherService_GetWeather_result {
 public:
  ...
  WeatherService_GetWeather_result(const WeatherService_GetWeather_result&) noexcept;
  WeatherService_GetWeather_result& operator=(const WeatherService_GetWeather_result&) noexcept;
  WeatherService_GetWeather_result() noexcept
                                   : success(static_cast<WeatherType::type>(0)) {
  }
...
class WeatherServiceProcessorFactory : public ::apache::thrift::TProcessorFactory {
 public:
  WeatherServiceProcessorFactory(const ::std::shared_ptr< WeatherServiceIfFactory >& handlerFactory) noexcept :
