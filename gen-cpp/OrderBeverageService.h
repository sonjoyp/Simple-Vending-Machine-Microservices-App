...
class OrderBeverageServiceIfSingletonFactory : virtual public OrderBeverageServiceIfFactory {
 public:
  ...
  virtual OrderBeverageServiceIf* getHandler(const ::apache::thrift::TConnectionInfo&) override {
    return iface_.get();
  }
  virtual void releaseHandler(OrderBeverageServiceIf* /* handler */) override {}
...
class OrderBeverageService_PlaceOrder_args {
 public:
  ...
  OrderBeverageService_PlaceOrder_args(const OrderBeverageService_PlaceOrder_args&) noexcept;
  OrderBeverageService_PlaceOrder_args& operator=(const OrderBeverageService_PlaceOrder_args&) noexcept;
  OrderBeverageService_PlaceOrder_args() noexcept
                                       : city(0) {
  }
...
class OrderBeverageService_PlaceOrder_result {
 public:
  ...
  OrderBeverageService_PlaceOrder_result() noexcept
                                         : success() {
  }
...
class OrderBeverageServiceProcessorFactory : public ::apache::thrift::TProcessorFactory {
 public:
  OrderBeverageServiceProcessorFactory(const ::std::shared_ptr< OrderBeverageServiceIfFactory >& handlerFactory) noexcept :
